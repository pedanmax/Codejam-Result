...
function cthuhlu(){
    ...
    // Функція яка формує масив першого етапу
    let firstStageArr = [];
    ...
    deck.addEventListener('click', cthuhluMini)
    let blueColor = 'blue';
    ...
    /*
    якщо у нас певна картка має клас виділення то по кліку на кнопку
    замішування викликається фукнція для конкретної картки
    */
}
export default cthuhlu